# Pull Request #69: feat(billing): generate GST compliant tax invoices with HSN codes and QR verification

**Module**: `Billing & Invoicing`
**Branch**: `feature/pr-069-order-invoice-pdf`
**Timestamp**: `2026-09-09 11:17:45 UTC`

## Summary of Changes
- feat(billing): generate GST compliant tax invoices with HSN codes and QR verification
