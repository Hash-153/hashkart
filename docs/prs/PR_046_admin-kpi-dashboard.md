# Pull Request #46: feat(admin): build seller analytics overview with GMV, orders and cancellation metrics

**Module**: `Admin & Operations`
**Branch**: `feature/pr-046-admin-kpi-dashboard`
**Timestamp**: `2026-09-09 11:08:56 UTC`

## Summary of Changes
- feat(admin): build seller analytics overview with GMV, orders and cancellation metrics
